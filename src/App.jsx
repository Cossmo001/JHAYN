...
function Navbar() {
  ...
  return (
    <nav className="w-full p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-white/70 dark:bg-gray-900/50 backdrop-blur-md sticky top-0 z-50 transition-colors duration-300">
      <a href="/" className="text-xl md:text-2xl font-black tracking-tighter bg-gradient-to-r from-lilac to-fuchsia-500 bg-clip-text text-transparent cursor-pointer">
        JHAYN Quiz
      </a>
      {user ? (
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="/auth" className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-900 dark:text-white px-5 py-2 rounded-full font-medium transition-colors border border-gray-300 dark:border-gray-700 text-sm md:text-base shadow-md">
            Login
          </a>
        </div>
      )}
